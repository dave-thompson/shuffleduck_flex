package com.shuffleduck.data
{
	...
	import com.shuffleduck.utils.XMLFormatter;
	...
	public class Deck extends DataModelItem
	{
		...
		public function toXMLString():String
		{
			...
			var xmlString:String = "<Deck version_no = \"" + ShuffleDuck.XML_VERSION_NO + "\" backward_compatible_iphone_version_no = \"" + ShuffleDuck.XML_BACKWARD_COMPATIBLE_IPHONE_VERSION_NO + "\">";
